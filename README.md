...
- **전역 30px 세이프 에리어 (Safe-area Layout)**: [v0.9.0] 모든 페이지(Library, Alignment, Settings, Task Manager)에 엄격한 좌측 정렬 기준선(30px)을 적용하여 시각적 일관성과 안정성 확보.
...
- **정밀 가사 동기화 도구 (Manual Lyric Sync)**: [v0.8.5] 탭-투-싱크(Tap-to-Sync) 방식의 고성능 가사 정렬 도구.
