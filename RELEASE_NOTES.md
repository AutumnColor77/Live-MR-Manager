...
OBS 오버레이 릴리즈(설치 버전) 연결 오류 수정 및 AI 가사 정렬 대기열 UI/UX 개선 릴리즈입니다. 기준: v0.7.5.
...
- **yt-dlp 갱신**: 관리형 `yt-dlp.exe`가 7일이 지났으면 GitHub latest로 다시 받습니다. 포맷 없음/nsig/403 류 실패 시 세션당 한 번 강제 갱신 후 재시도합니다.
