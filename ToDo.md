...
- [ ] **앱 버전 v0.4.10 메타데이터 정합성**: `package.json`, `Cargo.toml`, `tauri.conf.json` 버전 번호 일괄 갱신 (문서만 반영된 상태)

---

💡 **참고**: 이 목록은 우선순위에 따라 유동적으로 조정될 수 있습니다. v0.4.10 항목은 2026-05 기준 안정화 패치이며, 앱 버전 번호는 다음 릴리즈 때 일괄 올릴 예정입니다.
