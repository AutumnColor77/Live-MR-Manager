...
- [X] **Lyric Sync & Drawer 고도화**: 
    ...
    - **빈 가사 CTA (v0.7.0)**: 「가사 싱크 등록하러 가기」→ 드로어 닫고 가사 싱크 탭·현재 곡 로드.
...
- [X] **계정 메뉴·신청목록 로그인 UX (v0.7.2)**: 닉네임 메뉴(노래책/로그아웃), 게이트 Google/네이버 버튼, 업데이트 링크 opener 수정
